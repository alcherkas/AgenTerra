...
/// <summary>
/// Demonstrates knowledge readers for extracting text from various document formats.
/// Shows how to read text, Markdown, and PDF files using the document reader factory.
/// </summary>
public class KnowledgeReadersSample
{
    /// <summary>
    /// Runs the knowledge readers demonstration.
    /// </summary>
    ...
    private static async Task ReadDocumentSample(string filePath, DocumentReaderFactory factory)
    {
        Console.WriteLine($"\n--- Reading: {filePath} ---");
