...
/// <summary>
/// Demonstrates workflow session state management with a shopping cart example.
/// Shows how state persists across multiple workflow runs.
/// </summary>
public class WorkflowSessionStateSample
{
    /// <summary>
    /// Runs the workflow session state demonstration.
    /// </summary>
